...
public class Garage {
	...
	public void fix(Vehicles vehicleToFix) {
	...
	public void costRepairSingleTank(Tank vehicleToFix) {
		int total = 0;
	...
	public void costRepairSingleBike(PedalPowered vehicleToFix) {
		int total = 0;
		total = vehicleToFix.costOfRepair();
		total = (int) (total * 2);
		System.out.println("The cost to repair this vehicle is: £" + total);
	...
	public void costRepairSingleHorseDrawn(HorseDrawn vehicleToFix) {
		int total = 0;
		total = vehicleToFix.costOfRepair();
		total = (int) (total * 1.5);
		System.out.println("The cost to repair this vehicle is: £" + total);
	...
	public void costRepairHorseDrawn() {
		int total = 0;
